...
These files are cleaned Python exports of the notebooks in `notebooks/`.
...
The notebooks remain the primary narrative artifacts because they include explanations, cell outputs, charts, and training context. The scripts remove notebook markdown and cell markers so the code is easier to browse in GitHub.
